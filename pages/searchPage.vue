<template>
    <div class="w-full min-h-[100vh] text-white bg-gray-950 flex flex-col space-y-2 overflow-hidden">
        <div v-if="Movies && searchterm" class="grid sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-9 lg:gap-3 sm:gap-1 place-items-center h-full">
            <CardImage 
